...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/compute_tutorial1
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/compute_tutorial1
...
ifeq ($(config),release)
  OBJDIR     = obj/release/compute_tutorial1
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/compute_tutorial1
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking compute_tutorial1
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning compute_tutorial1
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/nvSDLFont.o: gKit/Widgets/nvSDLFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/compute_tutorial1.o: compute_tutorial1.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
