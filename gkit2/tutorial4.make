...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tutorial4
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/tutorial4
...
$(OBJDIR)/nvSDLFont.o: gKit/Widgets/nvSDLFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tutorial4.o: tutorial4.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
