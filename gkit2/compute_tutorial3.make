...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/compute_tutorial3
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/compute_tutorial3
...
ifeq ($(config),release)
  OBJDIR     = obj/release/compute_tutorial3
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/compute_tutorial3
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking compute_tutorial3
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning compute_tutorial3
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/nvSDLFont.o: gKit/Widgets/nvSDLFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/compute_tutorial3.o: compute_tutorial3.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
