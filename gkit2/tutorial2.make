...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tutorial2
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/tutorial2
...
$(OBJDIR)/nvSDLFont.o: gKit/Widgets/nvSDLFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tutorial2.o: tutorial2.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
