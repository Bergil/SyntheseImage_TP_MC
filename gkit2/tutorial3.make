...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tutorial3
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/tutorial3
...
$(OBJDIR)/nvSDLFont.o: gKit/Widgets/nvSDLFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tutorial3.o: tutorial3.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
