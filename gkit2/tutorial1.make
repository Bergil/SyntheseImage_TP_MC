...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tutorial1
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/tutorial1
...
$(OBJDIR)/nvSDLFont.o: gKit/Widgets/nvSDLFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tutorial1.o: tutorial1.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
